  ...
  updateUserData3: async (parent: any, args: any, context: Context) => {
     ...
     await context.prisma.user_data.update({
          ...
          data: {                   	                
            ...
            Address: {
              street: args.input.Address.street !== undefined ? args.input.street: null,
              city: args.input.Address.city !== undefined ? args.input.city: null,
              state: args.input.Address.state !== undefined ? args.input.state: null,
              zip: args.input.Address.zip !== undefined ? args.input.zip: null,
            },                          
            Year_of_manufacuring: args.input.Year_of_manufacuring !== undefined ? args.input.Year_of_manufacuring: null,
            FC_due_Date: args.input.FC_due_Date, CC: args.input.CC !== undefined ? args.input.FC_due_Date: null,
            ...
            GST_No: args.input.GST_No !== undefined ? args.input.Sleeper_Capacity: null,                          
            Mobile_No3 : args.input.Mobile_No3 !== undefined ? args.input.GST_No: null,
