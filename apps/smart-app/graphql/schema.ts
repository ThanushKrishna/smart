...
type Query {
    ...
    MAKE_BY_VALUE(data_owner_id: String!, input: String!): [MAKE]
    VEHICLE_COLOR_BY_VALUE(data_owner_id: String!, input: String!): [VEHICLE_COLOR]
    VEHICLE_NORMS_BY_VALUE(data_owner_id: String!, input: String!): [VEHICE_NORMS]
    CC_BY_VALUE(data_owner_id: String!, input: String!): [CC]
    MODEL_BY_VALUE(data_owner_id: String!, input: String!): [MODEL]
    INSURANCE_PROVIDER_BY_VALUE(data_owner_id: String!, input: String!): [INSURANCE_PROVIDER]
    PERMIT_CATEGORY_BY_VALUE(data_owner_id: String!, input: String!): [PERMIT_CATEGORY]
    TP_INSURANCE_PROVIDER_BY_VALUE(data_owner_id: String!, input: String!): [TP_INSURANCE_PROVIDER]
    VEHICLE_CLASS_BY_VALUE(data_owner_id: String!, input: String!): [VEHICLE_CLASS]
    CUSTOMER_TYPE_BY_VALUE(data_owner_id: String!, input: String!): [CUSTOMER_TYPE]
    VEHICLE_DESCRIPTION_BY_VALUE(data_owner_id: String!, input: String!): [VEHICLE_DESCRIPTION]
    SEATING_CAPACITY_BY_VALUE(data_owner_id: String!, input: String!): [SEATING_CAPACITY]
    STANDING_CAPACITY_BY_VALUE(data_owner_id: String!, input: String!): [STANDING_CAPACITY]
    RTO_BY_VALUE(data_owner_id: String!, input: String!): [RTO]
    HYPOTHECATION_BANK_BY_VALUE(data_owner_id: String!, input: String!): [HYPOTHECATION_BANK]
    HYPOTHECATION_CITY_BY_VALUE(data_owner_id: String!, input: String!): [HYPOTHECATION_CITY]
    UNLADEN_WEIGHT_BY_VALUE(data_owner_id: String!, input: String!): [UNLADEN_WEIGHT]
    GVW_BY_VALUE(data_owner_id: String!, input: String!): [GVW]
    VEHICLE_BODY_BY_VALUE(data_owner_id: String!, input: String!): [VEHICLE_BODY]
    WHEEL_BASE_BY_VALUE(data_owner_id: String!, input: String!): [WHEEL_BASE]
    NO_OF_CYLINDER_BY_VALUE(data_owner_id: String!, input: String!): [NO_OF_CYLINDER]
    SLEEPER_CAPACITY_BY_VALUE(data_owner_id: String!, input: String!): [SLEEPER_CAPACITY]
    UPDATED_BY_BY_VALUE(data_owner_id: String!, input: String!): [UPDATED_BY]
    REFERRED_BY_BY_VALUE(data_owner_id: String!, input: String!): [REFERRED_BY]
