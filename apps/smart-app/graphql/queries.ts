...
query User_data_NaInsuranceDueDate($input: String!) {
  user_data_NaInsuranceDueDate(input: $input) {
    id
    data_owner_id
    Vehicle_No
    RC_No
...
// Query for TP Insurance due date with null value
export const GET_USER_DATA_NA_TP_INSURANCE_DUE_DATE = gql`
  query User_data_NaTPInsuranceDueDate($input: String!) {
    user_data_NaTPInsuranceDueDate(input: $input) {
      id
    data_owner_id
    Vehicle_No
    RC_No
...
// Query for Emission due date with null value
export const GET_USER_DATA_NA_EMISSION_DUE_DATE = gql`
  query User_data_NaEmissionDueDate($input: String!) {
    user_data_NaEmissionDueDate(input: $input) {
      id
    data_owner_id
    Vehicle_No
    RC_No
...
// Query for Tax due date with null value
export const GET_USER_DATA_NA_TAX_DUE_DATE = gql`
  query User_data_NaTaxDueDate($input: String!) {
    user_data_NaTaxDueDate(input: $input) {
      id
    data_owner_id
    Vehicle_No
    RC_No
...
// Query for FC due date with null value
export const GET_USER_DATA_NA_FC_DUE_DATE = gql`
  query User_data_NaFCDueDate($input: String!) {
    user_data_NaFCDueDate(input: $input) {
      id
    data_owner_id
    Vehicle_No
    RC_No
